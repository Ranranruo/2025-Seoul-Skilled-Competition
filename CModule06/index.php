...
<body>
    ...
    <!-- 메인 영역 -->
    <main>
        <div class="visual oh" style="height: calc(100vh - 80px); margin-top: 80px; border-end-start-radius: 300px;">
            <ul class="df h slide" style="width: 400%;">
                <li class="bi w h df js ac" style="background-image: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)), url('./images/25.JPG');">
                    <div class="text h df jc fc g50" style="backdrop-filter: blur(3px); padding: 100px; background-color: rgba(0, 0, 0, .3); border-radius: 0px 300px 300px 300px;">
                        <div>
                            <p class="t cw1 f60">Better Give &amp; Take</p>
                            <p class="cw1 b f24">옴니채널 플랫폼 GIFTS로<br>전 세계 고객에게 선물의 가치를 높입니다.</p>
                        </div>
                        <div class="df g20"><button class="btn2 b bm cw1 b5 hd">Show More</button><button class="btn2 b cb b5 hd">About us</button></div>
                    </div>
                </li>
                <li class="bi w h df js ac" style="background-image: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)), url('./images/26.JPG');">
                    <div class="text h df jc fc g50" style="backdrop-filter: blur(3px); padding: 100px; background-color: rgba(0, 0, 0, .3); border-radius: 0px 300px 300px 300px;">
                        <div>
                            <p class="t cw1 f60">Life Style Platforms</p>
                            <p class="cw1 b f24">고객과 가장 가까운 곳에서<br>고객에게 다양한 즐거움을 선물합니다.</p>
                        </div>
                        <div class="df g20"><button class="btn2 b bm cw1 b5 hd">Show More</button><button class="btn2 b cb b5 hd">About us</button></div>
                    </div>
                </li>
                <li class="bi w h df js ac" style="background-image: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)), url('./images/28.JPG');">
                    <div class="text h df jc fc g50" style="backdrop-filter: blur(3px); padding: 100px; background-color: rgba(0, 0, 0, .3); border-radius: 0px 300px 300px 300px;">
                        <div>
                            <p class="t cw1 f60">Online PLAYGROUND</p>
                            <p class="cw1 b f24">업계 최초 당일 배송 서비스인 '오늘드림'으로<br>고객 니즈 충족과 고객 경험을 혁신합니다.</p>
                        </div>
                        <div class="df g20"><button class="btn2 b bm cw1 b5 hd">Show More</button><button class="btn2 b cb b5 hd">About us</button></div>
                    </div>
                </li>
        ...
        <section><div class="inner df fc g60">
            <div class="df jsb ae"><h1 class="t">Products</h1><a href="#" class="cm b">View More &gt;</a></div>
            <ul class="w df g30 fw">
                <li class="df fc g10">
                    <p class="cg">건강식품</p>
        ...
        <section class="bw3"><div class="inner df fc g50">
            <h1 class="t df jc">Notices</h1>
            <div class="df fc g10">
                <div id="noticeBtns" class="df je g30">
                    <div class="df g10">
                        <button data-type="type" data-value="" class="bw1 cb bx2 b5 btn1 b f16">전체</button>
                        <button data-type="type" data-value="일반" class="bw1 cb bx2 b5 btn1 b f16">일반</button>
                        <button data-type="type" data-value="이벤트" class="bw1 cb bx2 b5 btn1 b f16">이벤트</button>
                    </div>
                    <div class="df g10">
                        <button data-type="order" data-value="1" class="bw1 cb bx2 b5 btn1 b f16">Desc</button>
                        <button data-type="order" data-value="-1" class="bw1 cb bx2 b5 btn1 b f16">Asc</button>
                    </div>
                </div>
                <div class="bw1 bx2">
                    <!-- <li class="df bx2 bw1 hd jsb ac" style="height: 50px; padding: 10px;"><div class="df ac g20"><p class="btn1 b10 f12 bs cm df jc" style="width: 60px;">이벤트</p><p>ㅁ넝마ㅓ노어ㅏㅁㄴ</p></div><p class="cg b">2025.10.12</p></li> -->
                    <ul id="noticeList" class="oh" style="height: 300px;">
                        <div class="container">
                            <li class="df bx2 cp bw1 hd jsb ac" style="height: 50px; padding: 10px;"><div class="df ac g20"><p class="btn1 b10 f12 bs cm df jc" style="width: 60px;">이벤트</p><p>24년 7월 &lt;헬스+출석체크인&gt; 이벤트 당첨자 공지</p></div><p class="cg b">2024.08.08</p></li>
                            <li class="df bx2 cp bw1 hd jsb ac" style="height: 50px; padding: 10px;"><div class="df ac g20"><p class="btn1 b10 f12 bs cm df jc" style="width: 60px;">이벤트</p><p>7월 [기프트몰TV 보러갈래?] 이벤트 당첨자 발표</p></div><p class="cg b">2024.08.07</p></li>
                            <li class="df bx2 cp bw1 hd jsb ac" style="height: 50px; padding: 10px;"><div class="df ac g20"><p class="btn1 b10 f12 bs cm df jc" style="width: 60px;">일반</p><p>딘토 이벤트 조기 종료 안내</p></div><p class="cg b">2024.08.05</p></li>
                            <li class="df bx2 cp bw1 hd jsb ac" style="height: 50px; padding: 10px;"><div class="df ac g20"><p class="btn1 b10 f12 bs cm df jc" style="width: 60px;">일반</p><p>[배송안내] 8/14(수)~8/15(목) 택배사 휴무 관련</p></div><p class="cg b">2024.08.06</p></li>
                            <li class="df bx2 cp bw1 hd jsb ac" style="height: 50px; padding: 10px;"><div class="df ac g20"><p class="btn1 b10 f12 bs cm df jc" style="width: 60px;">일반</p><p>하월곡점 폐점으로 인한 영업종료 안내</p></div><p class="cg b">2024.07.31</p></li>
                            <li class="df bx2 cp bw1 hd jsb ac" style="height: 50px; padding: 10px;"><div class="df ac g20"><p class="btn1 b10 f12 bs cm df jc" style="width: 60px;">일반</p><p>양평점 리로케이션으로 인한 영업 중단 안내</p></div><p class="cg b">2024.07.31</p></li>
                        </div>
                    </ul>
                    <div class="df jc g20 ac f20 b cg" style="padding: 40px;"><button class="bw1 f24 minus">&lt;</button><p class="noticePage">1/6</p><button class="bw1 f24 plus">&gt;</button></div>
                </div>
            </div>
        </div></section>
        <section><div class="inner df fc g60">
            <div class="df fc g50">
                <h1 class="t">EnterProduct / Partnership</h1>
                <div class="df g50 fw">
                    <div class="bw1 hs bx2 cp b5 btn2 df fc jc ac" style="width: 305px;">
                        <i class="cm fa fa-clipboard" style="font-size: 50px;"></i>
                        <p class="b f20">상품입점/제휴문의</p>
                    </div>
                    <div class="bw1 hs bx2 cp b5 btn2 df fc jc ac" style="width: 305px;">
                        <i class="cm fa fa-search" style="font-size: 50px;"></i>
                        <p class="b f20">문의결과조회</p>
                    </div>
                    <div class="bw1 hs bx2 cp b5 btn2 df fc jc ac" style="width: 305px;">
                        <i class="cm fa fa-gears" style="font-size: 50px;"></i>
                        <p class="b f20">전자계약시스템</p>
                    </div>
                    <div class="bw1 hs bx2 cp b5 btn2 df fc jc ac" style="width: 305px;">
                        <i class="cm fa fa-child" style="font-size: 50px;"></i>
                        <p class="b f20">파트너시스템</p>
                    </div>
                </div>
            </div>
            <div class="df fc g50">
                ...
                <div class="df g20 fw">
                    ...
                    <div class="g20 cp bw1 hs bx2 b5 btn2 df fc ac" style="width: 211px; height: 250px;">
                        <i class="cm fa fa-clipboard" style="font-size: 50px;"></i>
                        <div class="df fc ac g5">
                            <p class="b f20">5.신용평가</p>
                            <p class="cg b f14">입점확정 협력사의 경우 신뢰있는 거래를 위해 신용평가를 받고 있습니다.</p>
                        </div>
                    </div>
                    <div class="g20 cp bw1 hs bx2 b5 btn2 df fc ac" style="width: 211px; height: 250px;">
                        <i class="cm fa fa-clipboard" style="font-size: 50px;"></i>
